...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    <div id="div_sch" class="div_sch">
        ...
        <div>
            <label>款号</label><asp:TextBox CssClass="middle" runat="server" ID="txb_kh_sch"></asp:TextBox></div>
        <div>
            <label>品名</label><asp:TextBox CssClass="middle" runat="server" ID="txb_pm_sch"></asp:TextBox></div>
        <div>
    ...
    <div id="div_edit" class="div_edit">
        <div>
            <asp:Label runat="server" Text="款号"></asp:Label><asp:TextBox CssClass="middle" runat="server" ID="txb_kh" ClientIDMode="Static"></asp:TextBox></div>
        <div>
            <asp:Label runat="server" Text="类型"></asp:Label><asp:DropDownList runat="server" ID="cmb_lx" ClientIDMode="Static"></asp:DropDownList></div>
        <div>
        ...
        <div>
            <asp:Label runat="server" Text="品名"></asp:Label><asp:TextBox CssClass="middle" runat="server" ID="txb_pm" ClientIDMode="Static"></asp:TextBox></div>
        <div>
