...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    <asp:GridView ID="grid_yonghu" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
        <Columns>
    ...
    <div id="div_edit" class="div_edit">
        <div><asp:Label runat="server" Text="登录名"></asp:Label><asp:TextBox CssClass="short"  runat="server" ID="txb_dlm" ClientIDMode="Static"></asp:TextBox></div>
        <div><asp:Label runat="server" Text="密码"></asp:Label><asp:TextBox CssClass="short"  runat="server" ID="txb_mm" ClientIDMode="Static"></asp:TextBox></div>
        <div><asp:Label runat="server" Text="用户名"></asp:Label><asp:TextBox CssClass="short"  runat="server" ID="txb_yhm" ClientIDMode="Static"></asp:TextBox></div>
        <div><asp:Label runat="server" Text="角色"></asp:Label><asp:DropDownList runat="server" ID="cmb_js" ClientIDMode="Static"></asp:DropDownList></div>
        ...
        <div><asp:Button runat="server" ID="btn_editxx" Text="修改" OnClick="btn_editxx_Click" /><asp:Button runat="server" ID="btn_add" Text="增加" OnClick="btn_add_Click" /></div>
    </div>
</asp:Content>
