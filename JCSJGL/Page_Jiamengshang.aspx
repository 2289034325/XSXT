...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_head" runat="server">
    ...
    <script type="text/javascript">
        //编辑
        function EditInfo(id,mc,zhs,khs,tms,hys,fds,cks,gyss,xsjls,jchjls,kcjls,scff,xfdj,jzrq,lxr,dh,bz) {
            $("#hid_id").val(id);
            $("#txb_mc").val(mc);
            $("#txb_zhs").val(zhs);
            $("#txb_khs").val(khs);
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    <asp:GridView ID="grid_jiamengshang" runat="server" AutoGenerateColumns="False" BackColor="White" 
        BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="id" OnRowDeleting="grid_jiamengshang_RowDeleting">
        <Columns>
    ...
    <div id="div_edit" class="div_edit">
        ...
        <div><asp:Label runat="server" Text="款号数"></asp:Label><asp:TextBox CssClass="short" runat="server" ID="txb_khs" ClientIDMode="Static"></asp:TextBox></div>
        ...
        <div><asp:Label runat="server" Text="仓库数"></asp:Label><asp:TextBox CssClass="short" runat="server" ID="txb_cks" ClientIDMode="Static"></asp:TextBox></div>
        <div><asp:Label runat="server" Text="供应商数"></asp:Label><asp:TextBox CssClass="short" runat="server" ID="txb_gyss" ClientIDMode="Static"></asp:TextBox></div>
        <div><asp:Label runat="server" Text="销售记录数"></asp:Label><asp:TextBox CssClass="short" runat="server" ID="txb_xsjls" ClientIDMode="Static"></asp:TextBox></div>
        <div><asp:Label runat="server" Text="进出货记录数"></asp:Label><asp:TextBox CssClass="short" runat="server" ID="txb_jchjls" ClientIDMode="Static"></asp:TextBox></div>
        <div><asp:Label runat="server" Text="库存记录数"></asp:Label><asp:TextBox CssClass="short" runat="server" ID="txb_kcjls" ClientIDMode="Static"></asp:TextBox></div>
        ...
        <div><asp:Button runat="server" ID="btn_edit" Text="保存" OnClick="btn_edit_Click" /><asp:Button runat="server" ID="btn_add" Text="增加" OnClick="btn_add_Click" /></div>
    </div>
</asp:Content>
