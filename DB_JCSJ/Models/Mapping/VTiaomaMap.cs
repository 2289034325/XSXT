...
namespace DB_JCSJ.Models.Mapping
{
    public class VTiaomaMap : EntityTypeConfiguration<VTiaoma>
    {
        ...
        {
            // Primary Key
            this.HasKey(t => new { t.id, t.laiyuan, t.jmsid, t.jms, t.ppid, t.pinpai, t.kuanhaoid, t.kuanhao, t.leixing, t.pinming, t.gysid, t.gys, t.gyskuanhao, t.tiaoma, t.yanse, t.chima, t.jinjia, t.shoujia, t.caozuorenid, t.charushijian, t.xiugaishijian });
