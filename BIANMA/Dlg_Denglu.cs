    ...
    public partial class Dlg_Denglu : Form
    {
        ...
        private void login(string dlm, string mm)
        {
            ...
            if (RuntimeInfo.LoginUser_BM != null)
            {
                ...
                {
                    Settings.Default.LoginUID = dlm;
                    Settings.Default.LoginPSW = mm;
        ...
        {
            string dlm = Settings.Default.LoginUID;
            string mm = Settings.Default.LoginPSW;
        ...
        private void btn_set_Click(object sender, EventArgs e)
        {
            Dlg_AppSettings da = new Dlg_AppSettings();
            da.ShowDialog();
        }
    }
}
